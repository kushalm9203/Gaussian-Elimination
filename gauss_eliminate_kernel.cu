...
// void gauss_eliminate_kernel(float *U, float* current_row, int k, int offset)
//{
...
__global__ void 
gauss_eliminate_kernel_optimized_div(float * U, int k, int stride)
{
	//With stride...
...
__global__ void 
gauss_eliminate_kernel_optimized(float * U, int k, int stride)
{
